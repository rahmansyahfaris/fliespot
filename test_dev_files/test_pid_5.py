...
# - now the debug logging prints in the movement loop rather than the logging loop
...
def log_pos_callback(timestamp, data, logconf):
    global pos_current_x, pos_current_y, pos_logging_x, pos_logging_y, pos_checkpoint_x, pos_checkpoint_y, isEnteringNewMovement
